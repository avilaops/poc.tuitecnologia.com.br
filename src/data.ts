...
export const pocRequirements: PocRequirement[] = [
  ...
  { ref: 'REF 06', title: 'Integrações', coverage: 'Demonstrável', view: 'integrations', evidence: 'Consulta real: processos via DataJud/CNJ (TJSP, TRF-3, TRT-15, STJ, TST) e citações/intimações via DJEN.' },
...
export const connectors: Connector[] = [
  ...
  { name: 'DJEN / Comunicações CNJ', group: 'CNJ', mode: 'real', tribunal: 'DJEN', detail: 'Citações e intimações do diário (consulta real)' },
